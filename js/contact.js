            ...
            <div>
                ...
                <div className="row container">
                    <p className="center-align">
                        <i className="material-icons dp48">my_location</i>&nbsp;
                ...
                <div className="container row">
                    <span id="facebook" className="contact_icon col s3 m1 offset-m4">
                    ...
                    <span id="instagram" className="contact_icon col s3 m1 ">
                        <i className="material-icons">
                            <svg viewBox="0 0 24 24">
                    ...
                    <span id="twitter" className="contact_icon col s3 m1">
                        <i className="material-icons">
                            <svg viewBox="0 0 24 24">
                    ...
                    <span id="youtube" className="contact_icon col s3 m1">
                        <i className="material-icons">
                            <svg viewBox="0 0 24 24">
